...
| `vueuse-functions` | github.com/serkodev (MIT, Copyright (c) 2026 SerKo) | LICENSE.md only; no upstream revision was ever recorded | 2026-08-02 — **user-authorized override**: the requirement map merged into `vue-best-practices/references/vueuse/`, MIT notice carried with the payload | **Retired to `attic/` 2026-08-02** |
| `native-feel-cross-platform-desktop` | MIT, Copyright (c) 2026 yetone | LICENSE only; no upstream revision was ever recorded | 2026-08-02 — retired unedited, no content extracted | **Retired to `attic/` 2026-08-02** |
