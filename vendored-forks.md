...
| `improve-codebase-architecture` | github.com/mattpocock/skills | `8b36d4fb2635b3c21998dcd8144439c9e5ba7302` (v1.2.2) | 2026-08-19 — report 與 reply prose 預設使用 zh-TW；technical terms、code identifiers、paths 與 domain terms 保持 English 或原文；tree SHA-256 `9c57cc581b532e7dbf752d09f15b06dd61e08199f151684da72accbddb96c8c7`; 2026-09-09 — approved description/ownership/branch-routing optimization (see batch record below); 2026-09-09 delta — approved Fable 5.1 audit delta (see "2026-09-09 Fable 5.1 audit delta" record below); 2026-09-10 shared audit — scope/routing/disclosure override; full before/after fixtures in docs/skill-overrides/2026-09-10-shared; 2026-09-11 — alternative-interface routing defers delegation to the updated design-it-twice workflow instead of promising parallel subagents; tree SHA-256 `a52d5278556bce310ee50d64e00ac10c381a78302c01be5fe038c65507d311c1`; 2026-09-12 — recorded authorization/ownership override (see dated record below); tree SHA-256 `19030209b43b6200acf48ad6d4a03685b7f7ffb931326f7cb01805ee6895a030` | **Active** |
...
| `triage` | github.com/mattpocock/skills | `8b36d4fb2635b3c21998dcd8144439c9e5ba7302` (v1.2.2) | 2026-08-06 — delegate question cadence to the canonical `grilling` contract instead of copying one-at-a-time or rounds behavior into the caller; tree SHA-256 `a10173ea5cf4563fceb4b23a0749fdba0762449c4a2a9ef3b7dcd124afc8a623`; 2026-09-09 — approved description/ownership/branch-routing optimization (see batch record below); 2026-09-10 shared audit — scope/routing/disclosure override; full before/after fixtures in docs/skill-overrides/2026-09-10-shared; 2026-09-12 — recorded authorization/ownership override (see dated record below); tree SHA-256 `4625a07b351d95f83db0a3009d4c44accf807bcaa274e33515e7346b46d083bc` | **Active** |
...
| `resolving-merge-conflicts` | github.com/mattpocock/skills | `8b36d4fb2635b3c21998dcd8144439c9e5ba7302` (v1.2.2) | 2026-09-09 — user-approved description/ownership/branch-routing optimization; baseline tree `52162eecbd8366e1d4b145e0964dfab7fe3cd534773d85e79c750f6e04aa65f5`; tree SHA-256 `b442690537b7375f2ea50da67aee174769b27dec9455ea62779f542340d51f60`; 2026-09-12 — recorded authorization/ownership override (see dated record below); tree SHA-256 `500dbfb5f59d21aba56f2dfa16bc945d19354be3c32cc821d523323fc0166063` | **Active** |
| `setup-matt-pocock-skills` | github.com/mattpocock/skills | `8b36d4fb2635b3c21998dcd8144439c9e5ba7302` (v1.2.2) | 2026-09-09 — user-approved description/ownership/branch-routing optimization; baseline tree `20fabc63fdb530037748eaf9b1a62a53ea91ac5a18cecc0fb001c3002b2673fc`; tree SHA-256 `8b7884991baff72c74b6773404d13105976c6229d683cafb2a58165370585631`; 2026-09-10 shared audit — scope/routing/disclosure override; full before/after fixtures in docs/skill-overrides/2026-09-10-shared; 2026-09-12 — recorded authorization/ownership override (see dated record below); tree SHA-256 `7d05458bfc0f1766544550d1114be691ec3b2b30073f078d5b0e9157c8b925b3` | **Active** |
...
| `wayfinder` | github.com/mattpocock/skills | `8b36d4fb2635b3c21998dcd8144439c9e5ba7302` (v1.2.2) | 2026-09-09 — user-approved description/ownership/branch-routing optimization; baseline tree `8c91f90c7129883d2c4cd1f7c255873e215c292801ecf4ed47af995a752b81dd`; tree SHA-256 `e9ee62e139a829fbc9cc3d43f6fb5c3a95e201bc5aea54010afe9fc0e78fb2d4`; 2026-09-10 shared audit — scope/routing/disclosure override; full before/after fixtures in docs/skill-overrides/2026-09-10-shared; 2026-09-11 — research tickets use shared INT-4 instead of one automatic subagent and branch per ticket; tree SHA-256 `1602431050363c55074639577eebbf4dbd5ca887aec80e40d000cbc65b581225`; 2026-09-12 — recorded authorization/ownership override (see dated record below); tree SHA-256 `1d4d62292d2e468d8dab38dbea7eb8fb28f3ea5d634e0980cbf76aa6fd8020d4` | **Active** |
...
|---|---|---|
| acquire-codebase-knowledge | `a2e22f4ca93df0577f17799f9a6685df2766f05b6a7746fc5cb11e80c6228d62` | `e843c69e54ab0236189d43b2bc9d87a2f1044b04146525b47ee046cb6d736ebf` |
...
| auditing-skill-folder | `77c70f727607c8ffb38e0a2ce78b92422897bbabea7548c43bebdd37074983e0` | `ad7880ab9262ff48b968657062a559e99cdd9eec1fa148680df9bec8e279b031` |
...
| css-ui-best-practices | `dc79e844bf625a2763eb30b0c1423c4cd3a3137b9839d3fcc63d42bb69cca333` | `b28697b5fce66226b0536f31ab458cb98299ff8577406b37daadbe0c4dfa7c1f` |
| dapper-best-practices | `3610e1d0a17e958b827aa9f3f5238e5f8e6eddebf8a53c87f727b0143d520e56` | `1e676cf70f910b84eea1b16386228812ede40bf8cf3a1c8cb8092c9f6e269439` |
...
| dev-workflow | `c995bc8e956fa2921f90d90656f4adbecfe40b5ab16d2a4849d370275db0f055` | `71210f961ac48d1c0a349324d684ce38a6bf0a77df659c83a304797225272b96` |
...
| ef6-best-practices | `c4f7a6a59dc44c54c184e409502781573808a8dd9f1066b65688bc957e1e9e62` | `f729e027c467ccdd632d04a60958658765679c1be8ae1dfaa246b7a43b541bfa` |
...
| improve-codebase-architecture | `19030209b43b6200acf48ad6d4a03685b7f7ffb931326f7cb01805ee6895a030` | `55b78fdffcd564bd9cf1ce04dd2cbb250dff4d822056b3c41fc859bcca603f9b` |
...
| jest-best-practices | `0b1c0405f87ef80b6aa014aeb890d01f3cfb05b3c5a74d95832adccf69f7acbc` | `cf05290217292fa9dd4d16788d256f9a8e308183860badcf499593260b34fcd0` |
...
| playwright-best-practices | `a6acb051248c5b219e2606847b8e4b77aa60f27938a36ca37fedb30852d36a9d` | `359783aefbab3e6b1fada7309fe74cb73b4d92415be77b359b1d146db42a2b2a` |
| postgresql-best-practices | `621518d7d85610700a564d1df8da38731a04b53bac967e1975aa3115b5c9aad3` | `5ce25b2609d25a161d3a324762e8a95e01cb87d6972ea2e9ce076ebfb5c372e1` |
| postgresql-optimization | `305ecac9e3bb689cbd118b2f81140afd84256703854053de670067447ebf3c3c` | `3fb74b0ae3595c8098810a8353b052171becd843750cfe8a9aefa625423df94b` |
| react-best-practices | `c90f0d28032bcc29228ea0122bc223fc0f5b4f352e7725cb85bf5cc328df6cb1` | `10cf00d1bcd7aeda39ce95cb02a26b4d6f8392c49d8b16ef5eb55abad95681f5` |
...
| security-audit | `96cc8af8979498933bea5df3e43a5430242b8458bbb3a7fc23f1bb3e29f273a7` | `a146dd2a5b06ed476885d36b2653e4b83a79cec4a0d225cf25d824c36b8489a9` |
| setup-matt-pocock-skills | `7d05458bfc0f1766544550d1114be691ec3b2b30073f078d5b0e9157c8b925b3` | `f52a7ecb62f61e0b42a75b2937666e80495480b74109802d994fcfb588dffbb5` |
...
| tailwind-v4-shadcn | `79f3ae6f9ad94274dbaad71165a3890e429e1e28a2b3ff3116ddd1594a54bb95` | `951d7d0b7aac78174434cc34d6c4e8d678c3c8bb5f8ffbdc129b63892e37834f` |
...
| triage | `4625a07b351d95f83db0a3009d4c44accf807bcaa274e33515e7346b46d083bc` | `a6a8fca8fba61617bcb6e94a405f2f49cd4908a2be9ac956425819d23283f293` |
...
| vue-best-practices | `3d7842bfa270495082a05d07ef2950350a21a2d2aeeea3262749c2890095808e` | `b5813b2e9e0ea2876bb59f95998b793fbd6f9a579da984c8f4f4d3dae7ad491f` |
| wayfinder | `1d4d62292d2e468d8dab38dbea7eb8fb28f3ea5d634e0980cbf76aa6fd8020d4` | `5789d703dd028d917ffeebe639f4a2526e6468582fbb3f5b595d2530a56e0cec` |
...
| improve-codebase-architecture | `9c57cc581b532e7dbf752d09f15b06dd61e08199f151684da72accbddb96c8c7` | `19030209b43b6200acf48ad6d4a03685b7f7ffb931326f7cb01805ee6895a030` | `55b78fdffcd564bd9cf1ce04dd2cbb250dff4d822056b3c41fc859bcca603f9b` | The deepening entrypoint now describes alternatives and leaves delegation to the routed design workflow. Current identity includes the 2026-09-12 recorded override below. |
| security-audit | `155518fb25be3a8d88566ea7fc051aef82b57bb2b4a11886f63793c40693a82c` | `96cc8af8979498933bea5df3e43a5430242b8458bbb3a7fc23f1bb3e29f273a7` | `a146dd2a5b06ed476885d36b2653e4b83a79cec4a0d225cf25d824c36b8489a9` | Recon/hunting use conditional delegation and scoped Phase 1 context; hunters return complete schema-backed candidate packets with field-preserving redaction at the coordinator handoff. Phase 3 binds independent validators to exact source while keeping prompts, returned verdicts, corrections, and every displayed or persisted Phase 4/5 output redacted before structural validation. |
| tailwind-v4-shadcn | `bbd4b1098c7ad46d915a8238ec870c787811328b43d9535cdc8f54ee3d78e493` | `79f3ae6f9ad94274dbaad71165a3890e429e1e28a2b3ff3116ddd1594a54bb95` | `951d7d0b7aac78174434cc34d6c4e8d678c3c8bb5f8ffbdc129b63892e37834f` | Color guidance preserves valid project-native oklch, hsl, and var formats. Current identity includes the 2026-09-12 recorded override below. |
| wayfinder | `e9ee62e139a829fbc9cc3d43f6fb5c3a95e201bc5aea54010afe9fc0e78fb2d4` | `1d4d62292d2e468d8dab38dbea7eb8fb28f3ea5d634e0980cbf76aa6fd8020d4` | `5789d703dd028d917ffeebe639f4a2526e6468582fbb3f5b595d2530a56e0cec` | Research tickets follow INT-4 and their authorized output contract instead of spawning one agent and branch per ticket. Current identity includes the 2026-09-12 recorded override below. |
...
### 2026-09-11 third current-head PR review follow-up

The next current-head review found six valid gaps and repeated one scanner-fixture premise that the
prior source-bound evidence had already disproved. `acquire-codebase-knowledge` now withholds
compound XML credential elements and malformed `name` / `key` attributes with an unclosed key
quote, while preserving the bounded safe near-matches. Its manifest scan keeps one full-text copy for
the required whole-file credential check, counts total lines without materializing a second full
line list, and slices only the first 80 lines for output. Its tree moves from
`9b5e6c39c86d320827708a2e0ba281ca703cbfbf74cc3a481689dff108344dee` to
`718ec635dd2d5398ec32649d88d6df66d809f0c5f2922c9c50b84f3f779a3e22`.

`init-project-docs` now resolves the repository root and absolute edited-file path before computing
the debounce marker, so identical relative paths in different repositories do not collide. The hook
header also states its actual contract: the repository command runs synchronously and the hook
reports the result with exit zero. Its tree moves from
`2fb78eb6ea24fa14409ec8bdd340c7ccc1db3bb1853fe2f5353979152c219276` to
`421dd8346d3d90a1ed9ede3137d3371113266fad543a12d2f0e3fffddb24c0bb`.

`security-audit` now requires each Phase 2 hunter to return the complete schema-backed candidate
packet that Phase 3 must validate, including the report fields and every execution and remediation
input. Its tree moves from
`1f675cc40bc37cb2d043a73bab8600ea9fffb534310b1bf079fdb9656a4fd531` to
`c74e79ae8f02d2ce533f0f8abbda0f46f9a70588cc9a895b88f68be8e9d645ec`.

Six vertical regression slices each fail once on the immediately preceding source and pass after
the corresponding correction; the combined carrier reaches 540 PASS / 0 FAIL. The separate
URL-userinfo-only fixture still contains a literal scheme, userinfo and `@`, and its prior-source
control plus detector mutation prove that path is exercised, so no duplicate source change is made
for that repeated premise. Rollback restores the three before trees, the prior current fingerprint
and the six matching regression changes together; earlier review records remain historical
snapshots.

### 2026-09-11 fourth current-head PR review follow-up

The current-head review found seven corrections across the existing scanner, hook-input, validation,
and provenance contracts. `acquire-codebase-knowledge` now recognizes `DB_PASS` and
`ENCRYPTION_KEY` across assignments, XML elements, and bounded `name` / `key` attributes while
preserving `compass`, `bypass`, and suffix near-matches. Its XML element detector stops at the
credential-shaped element name instead of searching for an unbounded closing `>`, and manifest
preview inspection reads at most 1,000,001 decoded characters before withholding the entire preview.
Its tree moves from `718ec635dd2d5398ec32649d88d6df66d809f0c5f2922c9c50b84f3f779a3e22`
to `10e56d1d20e9104e13744d3fa294294704f17cf7644e8acbb9d67c6df3c43522`.

`init-project-docs` now selects the first nonempty string from the supported JSON target fields,
skips null, boolean, number, and empty-string candidates, and retains the environment target when
the payload has no usable string. Its tree moves from
`421dd8346d3d90a1ed9ede3137d3371113266fad543a12d2f0e3fffddb24c0bb` to
`4479fa1c08178fa1e814c093b869052e0cde7f6094de960ed33d9ad5a2787c59`.

`security-audit` now reuses the `REPORT.md` validation-provenance section for every candidate,
recording reviewer identity, mechanism, exact reviewed source identity, verdict, and field-specific
evidence. Retained candidates bind clean Git, dirty Git, and non-Git inputs to the applicable commit,
diff, or snapshot hashes; source drift requires refreshed evidence and independent revalidation
before promotion. Its tree moves from
`c74e79ae8f02d2ce533f0f8abbda0f46f9a70588cc9a895b88f68be8e9d645ec` to
`0bb95ebf349ca7b9a86b2975522d707c1c4535d172f799b6ae4a628b18cd6676`.

The seven regression slices start at 540 PASS / 7 FAIL on the preceding source and reach 547 PASS /
0 FAIL after these fixes. No new audit artifact, schema field, or framework was introduced. Rollback
restores the three before trees, their prior current fingerprints, and the seven matching regression
changes together; earlier review records remain historical snapshots.

### 2026-09-11 independent r8 S5 follow-up

The independent review of the seven-fix candidate found three gaps in its shared input boundaries.
`acquire-codebase-knowledge` now recognizes the bare `pass` alias without hiding `compass`,
`bypass`, `passPolicy`, or the bounded suffix controls; XML `name` / `key` values accept the same
compound prefixes as assignment and element keys. The URL userinfo detector now requires a scheme
start boundary, avoiding repeated suffix scans across long safe scheme-character runs while retaining
standard and custom schemes with userinfo. Its tree moves from
`10e56d1d20e9104e13744d3fa294294704f17cf7644e8acbb9d67c6df3c43522` to
`ac7885e8bd949532a72b88682fef6b49392718998dabd8291e09478b2e0c1bd0`.

`init-project-docs` now uses optional jq field access before choosing the first nonempty string, so a
scalar or array in an earlier parent field cannot suppress a later valid path or the existing
environment fallback. Its tree moves from
`4479fa1c08178fa1e814c093b869052e0cde7f6094de960ed33d9ad5a2787c59` to
`a08c0f4d278fb466175eab47f8ebe04f784427df0f70f9d6a92ce549287efb37`.

The three amended controls start at 544 PASS / 3 FAIL on the frozen r8 candidate and return the
unchanged 547-check carrier to 547 PASS / 0 FAIL after the fixes and current-fingerprint update.

### 2026-09-11 amended-candidate assignment follow-up

The independent review of the amended candidate found two assignment-only regressions: the shared
compound-prefix expression made long safe hyphenated input quadratic, while its global left boundary
missed existing camel-case aliases such as `awsAccessKeyId`. Assignment matching now keeps the prior
suffix behavior for established credential aliases and gives only bare `pass` an alphanumeric left
boundary. This retains `app_pass` and `app-pass` while leaving `compass` and `bypass` visible. XML
element and attribute matching retain their bounded compound-prefix handling. The
`acquire-codebase-knowledge` tree moves from
`ac7885e8bd949532a72b88682fef6b49392718998dabd8291e09478b2e0c1bd0` to
`3f85968fcb30997b20649c4af9e633b014f1dbad551331933e62cfa4bedf369d`.

The existing credential-alias carrier now covers both regressions without adding a new carrier case.
Rollback restores the amended-candidate scanner, its prior current fingerprint, and the matching
carrier assertions together; earlier review records remain historical snapshots.
Rollback restores the two prior trees, their prior current fingerprints, and the amended fixture
inputs together; the frozen r8 package and earlier review records remain immutable evidence.

### 2026-09-11 r9 current-head review follow-up

The current-head review identified five corrections and one source-binding gap across three
existing contracts. `acquire-codebase-knowledge` reports recognized manifest file names without
emitting raw manifest values in either stdout or authorized output-file mode. This single boundary
covers ordinary and credential-shaped content across JSON, XML, Gradle, Ruby, Make, and binary
manifests instead of maintaining format-specific preview regexes. Dotenv summaries read at most
1,000,001 decoded characters and withhold oversized input while retaining the existing
key/state/line and quoted-continuation behavior below the limit. Its tree moves from
`3f85968fcb30997b20649c4af9e633b014f1dbad551331933e62cfa4bedf369d` to
`74677240e19e25edfa58f1325b1bae94cbba2c55811d503c2dc8fa1fb1fac9bc`.

`init-project-docs` skips `.test` / `.spec` files with the `mts`, `cts`, `mjs`, and `cjs` suffixes.
The hook uses portable `cksum` for its debounce identity and reports `NOT_RUN` before executing the
configured command when a valid checksum is unavailable. Its reference index makes registration
depend on an explicitly provided `AGENT_TEST_COMMAND`. Its tree moves from
`a08c0f4d278fb466175eab47f8ebe04f784427df0f70f9d6a92ce549287efb37` to
`47e7b58e33ba2948ce5a2320d91fc8bca6776823c00696a9ccb228f583ce5807`.

`security-audit` binds both the research validator and the distinct fresh-context fallback to the
same exact clean-Git, dirty-Git, or non-Git reviewed source identity before validation. The S5
amendment also provides the exact reviewed dirty diff or non-Git snapshot and requires either
validator to verify the identity it actually reads before confirming; a mismatch refreshes the
complete candidate and triggers fresh independent validation. Its tree moves from
`0bb95ebf349ca7b9a86b2975522d707c1c4535d172f799b6ae4a628b18cd6676` to
`674f3f63741ff13b2fd23334f90cb4885dd23a2748d4f2e165d2407e180fd269`.
The report schema remains unchanged because the reviewed producer and Phase 3 validator already
require complete execution content; the proposed schema minimum lacked a promotion-bypass
reproduction.

The new controls start at 546 PASS / 6 FAIL on the frozen r8 source. Ten preview-specific cases are
...
### 2026-09-12 r12 security-output redaction follow-up

The current-head review found that a complete Phase 2 candidate could cross the hunter-to-coordinator
handoff before redaction and that a validator with exact source access could reintroduce a sensitive
literal into its return or later report output. `security-audit` now keeps one complete,
field-preserving redacted record across the hunter handoff, validator prompts and returns,
`REVISION_REQUIRED` corrections, every displayed or persisted Phase 4 report, and `findings.json`
before the structural validator reads it. Non-sensitive structure, source locations, relevant
set/unset evidence, and field-path redaction notes remain in existing evidence or validation
provenance surfaces. The schema and structural validator remain unchanged. The tree moves from
`674f3f63741ff13b2fd23334f90cb4885dd23a2748d4f2e165d2407e180fd269` to
`96cc8af8979498933bea5df3e43a5430242b8458bbb3a7fc23f1bb3e29f273a7`.

The test-only carrier starts at 546 PASS / 2 FAIL while its complete redacted confirmed fixture
already passes the unchanged structural validator. The two contract controls and current-fingerprint
update bring the carrier to 548 PASS / 0 FAIL. A schema mutant that requires integer payloads makes
the redacted fixture fail, confirming that the new fixture exercises the validator path. Rollback
restores the prior tree and fingerprint and removes the three matching carrier controls together;
earlier review records remain historical snapshots.

### 2026-09-12 shared authorization and ownership recorded override

**Decision:** the user approved implementation in the recommended order; the corresponding shared provenance update is part of that implementation. This is the recorded override for the 19 changed shared skill trees listed below, based on local HEAD `3e2607ea4cea320ee9a8e2a2bd4b8e0ddb238f4b`. Delivery Scope: Local-only. This record neither activates live skills nor authorizes a future upstream refresh or additional source edits.

The active fork index, maintained 2026-09-10 Candidate fields, and explicitly Current fields in the 2026-09-11 table carry the current identities. Earlier index annotations, Before fields, upstream revision pins, licenses, archived payloads, and historical batch snapshots remain intact. The Before values below are the actual HEAD baseline; the complete pre-integration ledger is preserved in the parent implementation report. In particular, the previous dev-workflow candidate row had already drifted from that HEAD and is retained there as prior evidence, not treated as the current baseline.

Only Playwright intersects the generic provenance lock: its payload and tree hashes are refreshed with that lock's existing formulas, preserving the source URL and assessed revision. No changed skill intersects the four-row Stage B2 lock. The existing 22-skill invocation manifest still verifies as `6e30f32c601ef6473c6895e1e536f87f4ec9a3e179dea19587b5f578d248643a`; neither lock needs a no-op rewrite. Self-owned skill rows below record current identities without adding them to the vendored fork index.

These Current hashes record the reviewed source state. Existing CI validates named skill/lock contracts, not every row of this table against future drift; update the affected provenance records when source changes.

| Skill | Before tree SHA-256 at HEAD | Current tree SHA-256 | Current SKILL.md SHA-256 | Recorded delta |
|---|---|---|---|---|
| acquire-codebase-knowledge | `e39c0fe4fe566941ce87dce0739afef3452131c585a64cc5a89b5d2283c7a72a` | `a2e22f4ca93df0577f17799f9a6685df2766f05b6a7746fc5cb11e80c6228d62` | `e843c69e54ab0236189d43b2bc9d87a2f1044b04146525b47ee046cb6d736ebf` | Keep repository discovery in the session unless persistent codebase documents or scan artifacts are already authorized; preserve authorized Full map completion and read-only boundaries. |
| auth-implementation-patterns | `090546188425be2bbc9ea89eeb7a7b5899b87cad789fb2314803921e6357471a` | `4903234d62fef468a43b82378c7cf55dd66e7b06c2347ee7ab59807961bfe973` | `addc849a2a9a2d67e5d1f285eafe962cf166dbe25a663e8a2af5307c33c48112` | Route current provider syntax through native official docs before the existing Context7 fallback. |
| css-ui-best-practices | `b99bfb85e1825bbe8c9a79db2d557ecd6b36647b6a36735c1416be5ef962c39e` | `dc79e844bf625a2763eb30b0c1423c4cd3a3137b9839d3fcc63d42bb69cca333` | `b28697b5fce66226b0536f31ab458cb98299ff8577406b37daadbe0c4dfa7c1f` | Scope animation, image-loading, and important-override review findings to the relevant evidence and project context. |
| dapper-best-practices | `c97379e2f65e555c3429278acdc50ccf85fcd97f526e5261edcb610183228544` | `3610e1d0a17e958b827aa9f3f5238e5f8e6eddebf8a53c87f727b0143d520e56` | `1e676cf70f910b84eea1b16386228812ede40bf8cf3a1c8cb8092c9f6e269439` | Route confirmed non-Dapper paths to their owner and continue the authorized task. |
| auditing-skill-folder | `8e34f68c1d5c76aa4e64ddb5060e3ff65319cddc18c27b34cb63cb79bf64e391` | `77c70f727607c8ffb38e0a2ce78b92422897bbabea7548c43bebdd37074983e0` | `ad7880ab9262ff48b968657062a559e99cdd9eec1fa148680df9bec8e279b031` | Add repository mapping, Tailwind integration and in-progress conflict fire/quiet fixtures; native firing remains UNAVAILABLE until its runner succeeds. |
| dev-workflow | `15076a1c562637331c21ef3477b0e4bc9d0de84cc49332cb05531e0a528ea28a` | `c995bc8e956fa2921f90d90656f4adbecfe40b5ab16d2a4849d370275db0f055` | `71210f961ac48d1c0a349324d684ce38a6bf0a77df659c83a304797225272b96` | Clarify S2, [INT-10] and S5 ownership; extract implementation and split routing continuations for conditional loading while preserving hard gates and active host overrides. |
| improve-codebase-architecture | `a52d5278556bce310ee50d64e00ac10c381a78302c01be5fe038c65507d311c1` | `19030209b43b6200acf48ad6d4a03685b7f7ffb931326f7cb01805ee6895a030` | `55b78fdffcd564bd9cf1ce04dd2cbb250dff4d822056b3c41fc859bcca603f9b` | Use the canonical codebase-design deletion test and actual caller evidence. |
| playwright-best-practices | `a14c2bca1f11a8665f30cfdc0595c15f5d57cdb3af42aab6e18a2238ba2e9f08` | `a6acb051248c5b219e2606847b8e4b77aa60f27938a36ca37fedb30852d36a9d` | `359783aefbab3e6b1fada7309fe74cb73b4d92415be77b359b1d146db42a2b2a` | Default to host-supported task isolation, distinguish reuse from explicit closure authorization, and re-observe task-owned page indices before each close. |
| postgresql-best-practices | `91b69e636cb33d8f8c3609b235acb59ca2566db65a6a6fdf703faa0f30da4007` | `621518d7d85610700a564d1df8da38731a04b53bac967e1975aa3115b5c9aad3` | `5ce25b2609d25a161d3a324762e8a95e01cb87d6972ea2e9ce076ebfb5c372e1` | State the tuning owner and move the full EXPLAIN reading guide there; scope statistics maintenance to existing authorization. |
| postgresql-optimization | `45188feacc55240882eb226e9beae48b50f17fbd367628b4297baaef01fe247c` | `305ecac9e3bb689cbd118b2f81140afd84256703854053de670067447ebf3c3c` | `3fb74b0ae3595c8098810a8353b052171becd843750cfe8a9aefa625423df94b` | Reuse approved probe scope, retain side-effect gates, and own the EXPLAIN guide with accurate shared-buffer read terminology; statistics reset requires authorization. |
| react-best-practices | `e3931362133299e10b46ce13f0d7b2b1e5a5bc00b91143837a90141cc490ab31` | `c90f0d28032bcc29228ea0122bc223fc0f5b4f352e7725cb85bf5cc328df6cb1` | `10cf00d1bcd7aeda39ce95cb02a26b4d6f8392c49d8b16ef5eb55abad95681f5` | Route confirmed Vue or non-React work to its owner without ending the authorized task. |
| resolving-merge-conflicts | `b442690537b7375f2ea50da67aee174769b27dec9455ea62779f542340d51f60` | `500dbfb5f59d21aba56f2dfa16bc945d19354be3c32cc821d523323fc0166063` | `44c6fca765ed04566091d178de26842a4604194809a5979528043f8301ed6008` | Shorten the description while retaining in-progress conflict applicability and existing authorization/closeout gates. |
| setup-matt-pocock-skills | `8b7884991baff72c74b6773404d13105976c6229d683cafb2a58165370585631` | `7d05458bfc0f1766544550d1114be691ec3b2b30073f078d5b0e9157c8b925b3` | `f52a7ecb62f61e0b42a75b2937666e80495480b74109802d994fcfb588dffbb5` | Reuse confirmed tracker mappings; ask only for materially unresolved mappings while preserving explicit-only invocation. |
| tailwind-v4-shadcn | `7c8ffe8eb2fb601f9e4dadb18ab0efd2091a1292c874d026a510228a01077b95` | `79f3ae6f9ad94274dbaad71165a3890e429e1e28a2b3ff3116ddd1594a54bb95` | `951d7d0b7aac78174434cc34d6c4e8d678c3c8bb5f8ffbdc129b63892e37834f` | Narrow description to Tailwind v4 and shadcn setup, migration, or relevant integration failures. |
| triage | `a10173ea5cf4563fceb4b23a0749fdba0762449c4a2a9ef3b7dcd124afc8a623` | `4625a07b351d95f83db0a3009d4c44accf807bcaa274e33515e7346b46d083bc` | `a6a8fca8fba61617bcb6e94a405f2f49cd4908a2be9ac956425819d23283f293` | Reuse authorized queue and action scope; distinguish state decisions from external mutations and retain the user decision gate. |
| vue-best-practices | `a17da191a4e8004a7117389f9b6461b9575c859e994c0fcf4aa02142993174ae` | `3d7842bfa270495082a05d07ef2950350a21a2d2aeeea3262749c2890095808e` | `b5813b2e9e0ea2876bb59f95998b793fbd6f9a579da984c8f4f4d3dae7ad491f` | Continue authorized work through the correct framework owner and reuse existing VueUse dependency authorization. |
| wayfinder | `1602431050363c55074639577eebbf4dbd5ca887aec80e40d000cbc65b581225` | `1d4d62292d2e468d8dab38dbea7eb8fb28f3ea5d634e0980cbf76aa6fd8020d4` | `5789d703dd028d917ffeebe639f4a2526e6468582fbb3f5b595d2530a56e0cec` | Accept explicit delegation of the specific frontier decision while retaining default HITL and separate action authorization. |
| ef6-best-practices | `023c9e45d152649bd158233c814e82d3dfc4645004989e086acf1d2f8ac999b0` | `c4f7a6a59dc44c54c184e409502781573808a8dd9f1066b65688bc957e1e9e62` | `f729e027c467ccdd632d04a60958658765679c1be8ae1dfaa246b7a43b541bfa` | Assign review severity from demonstrated impact; preserve S2 migration risk and distinguish style suggestions. |
| jest-best-practices | `0e6a053968a416681ebec39b49f3cbb3735201dd68a807f37bdbed9e63431d28` | `0b1c0405f87ef80b6aa014aeb890d01f3cfb05b3c5a74d95832adccf69f7acbc` | `cf05290217292fa9dd4d16788d256f9a8e308183860badcf499593260b34fcd0` | Preserve repo coverage and assess handwritten utility behavior instead of excluding utilities by name. |

**Re-merge:** compare only these changed skills with their retained upstream pins and the named local baseline. Reapply still-needed authorization, ownership, description, and reference-routing changes; preserve user-only invocation, read-only requests, material-decision gates, external-side-effect boundaries, and active host overrides. Use `skills/auditing-skill-folder/scripts/lib-vendored.sh` for canonical tree identities and the existing generic lock payload formula. Run the existing vendored-detection and matt-thin-workflow contracts; report genuine source/test mismatches to their owner rather than weakening them. The parent report records actual results; this entry does not assert model behavior or an all-green gate.

**Rollback:** from the recorded candidate identities, reverse only this round's source hunks and its one added dev-workflow reference against the named HEAD, together with their current provenance fields and lock delta. Restore an entire file only when its current hash still matches the recorded candidate and it contains no concurrent work; otherwise reverse the exact hunks. Retain all earlier history, upstream pins, licenses, invocation modes, and unrelated changes. No rollback is executed by this integration.


The EF6 review-severity and Jest coverage rows complete the original approved audit recommendations. They change instruction wording only; repository coverage requirements and the canonical migration authorization boundary remain intact.
