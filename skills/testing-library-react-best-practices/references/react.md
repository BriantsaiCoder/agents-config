...
React-specific Testing Library patterns. Use this reference for React applications, components, hooks, context providers, forms, error boundaries, portals, and Suspense. For general workflow, query priority, and the review checklist, see the parent `testing-library-react-best-practices/SKILL.md`. For TDD workflow, load the `tdd` skill.
...
- [ ] Following the parent SKILL.md workflow and query priority
