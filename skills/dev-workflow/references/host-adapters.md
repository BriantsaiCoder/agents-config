...
CAP-LOCAL-AUTONOMY	安全、local、reversible 工作可自主完成	local、reversible^MUST 一次執行至完成	Low／Medium-risk^local、reversible^可直接實作	Low／Medium-risk^local、reversible^可直接實作
