...
Claude／Copilot 的 2026-09-10 核准來源為已核准的 Ponytail 4.9.0 修改內容；Codex 的核准來源為已 review 並合併的 [dotcodex #35](https://github.com/BriantsaiCoder/dotcodex/pull/35) `maintenance/ponytail/skill-optimization.json` canonical target `skills/ponytail/SKILL.md` 的 `after_sha256`。更新 payload 須先獨立 review，再更新該 host pin，不可為讓 checker 通過而從未核准的 live 檔自動重算。

```tsv
PONYTAIL-SHA256	Claude	42167fda5759eb53e2f2f04983785f9a8269ebe438f1a055c296b3667f435eaf
PONYTAIL-SHA256	Codex	75bb7abc9d3abaf7b6cd4ca4534c24375f8f0ee1d0c3b01dc6dc022f6c8e7a37
