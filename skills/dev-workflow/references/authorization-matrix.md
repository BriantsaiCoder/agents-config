...
High、protected boundary 或 material scope expansion 必須停在 S2；只有會改變 outcome／scope／risk 的 material ambiguity 才停下發問。低風險、可逆、無 material impact 採 sensible default 並記 default／impact。
