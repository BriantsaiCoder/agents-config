...
Persistence (Master + Overrides pattern):
  ...
  --force        Overwrite existing requested files (without this, each existing
                 Master/page target is preserved independently)
"""
...
# Keep normal skill execution from mutating the pinned vendored tree.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--force", action="store_true", help="Overwrite existing requested files when persisting (default: preserve each existing target)")
