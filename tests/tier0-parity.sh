...
#   [T0-1]/[T0-5]/[T0-7] Claude/Copilot 保留舊 blanket gate，Codex 已採 risk-based contract（[T0-1]、[T0-5] 於 2026-09-08
#   三家對齊；Codex [T0-1] 另保留獨有的「同 session 目標／狀態未變可重用」子句，本表沒有 clause 守它，mirror 或
#   accepted divergence 待決）；
